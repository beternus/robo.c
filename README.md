...
O arquivo correto é o robofinal. Os demais são arquivos auxiliares. Este arquivo pode ser compilado para o Arduino, seguida de posterior montagem do robô.
